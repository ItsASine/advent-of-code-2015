/*
 ...
 You start by writing up a list of everyone invited and
 the amount their happiness would increase or decrease if they were to find
 themselves sitting next to each other person.
 You have a circular table that will be just big enough to fit everyone
...
var knightsOfTheDinnerTable = require('./app/knights');

console.log(knightsOfTheDinnerTable.day13());
console.log(knightsOfTheDinnerTable.part2());
